...
CKEDITOR.plugins.add( 'widgetbootstrap', {
    ...
    init: function( editor ) {
		...
		editor.widgets.add( 'widgetbootstrapX', {

            button: showButtons ? 'Add left column box' : undefined,

            template:
                '<img class="pull-right img-responsive" src="http://placehold.it/300x250&text=Image" />',
        ...
        editor.widgets.add( 'widgetbootstrapLeftCol', {
            ...
            template:
                '<div class="row">' +
                    '<div class="col-md-3"><img class="img-responsive" src="http://placehold.it/300x250&text=Image" /></div>' +
        ...
        editor.widgets.add( 'widgetbootstrapTwoCol', {
            ...
            template:
                '<div class="row two-col">' +
                    '<div class="col-md-6 col-1"><img class="img-responsive" src="http://placehold.it/500x280&text=Image" />Content</div>' +
                    '<div class="col-md-6 col-2"><img class="img-responsive" src="http://placehold.it/500x280&text=Image" />Content</div>' +
                '</div>',
        ...
        editor.widgets.add( 'widgetbootstrapThreeCol', {
            ...
            template:
                '<div class="row ">' +
                    '<div class="col-md-4 col-1"><img class="img-responsive" src="http://placehold.it/400x225&text=Image" />Text below</div>' +
                    '<div class="col-md-4 col-2"><img class="img-responsive" src="http://placehold.it/400x225&text=Image" />Text below</div>' +
                    '<div class="col-md-4 col-3"><img class="img-responsive" src="http://placehold.it/400x225&text=Image" />Text below</div>' +
                '</div>',
            ...
            upcast: function( element ) {
                return element.name == 'div' && element.hasClass( '' );
            }
